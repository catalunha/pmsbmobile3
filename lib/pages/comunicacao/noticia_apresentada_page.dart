...
class NoticiaApresentadaPage extends StatefulWidget {
  @override
  _NoticiaApresentadaPageState createState() => _NoticiaApresentadaPageState();
}

class _NoticiaApresentadaPageState extends State<NoticiaApresentadaPage> {
