...
import 'package:firebaseauth_wrapper_flutter/firebaseauth_wrapper_flutter.dart' as ffbaw;
class Bootstrap {
  static final Bootstrap instance = Bootstrap(ffsw.Firestore(), ffsw.FieldValue(), ffbaw.FirebaseAuth());
