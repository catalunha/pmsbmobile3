...
class PerguntaWigdetImagemArquivoTeste extends StatefulWidget {
  final ArquivoTipo arquivoTipo;

  PerguntaWigdetImagemArquivoTeste({Key key, @required this.arquivoTipo})
      : super(key: key);

  @override
  _PerguntaWigdetImagemArquivoTesteState createState() =>
      _PerguntaWigdetImagemArquivoTesteState();
}

class _PerguntaWigdetImagemArquivoTesteState
    extends State<PerguntaWigdetImagemArquivoTeste> {
   ...
   * arquivos.getListaAquivos()
   */

  File _image;

  String _mensageaquivo = "Selecione o arquivo pelo (SO) (camera) :";
  String _mensageimagem = "Selecione o arquivo pelo (SO) (camera) :";
