...
class GetImagemArquivo extends StatefulWidget {
  final ArquivoTipo arquivoTipo;

  GetImagemArquivo({Key key, @required this.arquivoTipo})
      : super(key: key);

  @override
  _GetImagemArquivoState createState() =>
      _GetImagemArquivoState();
}

class _GetImagemArquivoState
    extends State<GetImagemArquivo> {
